function [corr1,grad1,grad2,xcoef,ycoef,S11,S12,T,K11,D]=DCCA_corr(X1,X2,K,rcov1,rcov2)
%%
...
% Compute correlation CCA style from paper 2013 galen andrew
% K11 is the C_{xx}^{(-1/2)}
T=K11*S12*K22; [U,D,V]=svd(T'*T,0);
